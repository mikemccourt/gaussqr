...
% we're not there yet.
%
% This is not required for understanding how to use aspects of the
% Hilbert-Schmidt SVD or related research content.  Instead, this example
% is used to demonstrate the functionality of certain underlying content
% that is necessary for the stable computation.
