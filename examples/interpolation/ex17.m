% ex17
% This puts together convergence order pictures for HS-SVD basis associated
% with the IBB kernels
...
% Not all function values are actually acceptable, but most are ... we need
% to figure out what is working correctly
fopt = 17;
