function [ g ] = genBoundarySatisfyingFunction( f, lbsat, rbsat, lbound, ubound, lbval, rbval )
...
yright = subs(d-currbval,x,sym(ubound)); % line will pass
xright = sym(ubound);
...
if curSatDegree == 0
    ...
    g = genBoundarySatisfyingFunction(newf, newlbsat, newrbsat, lbound, ubound, lbval, rbval);
end
