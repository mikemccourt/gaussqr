...
% We are considering the low-rank eigenfunction approximate basis for the
% construction of the differentiation matrix here.
%
...
%
% Unlike ex13, this considers a range of ep and alpha values and that
