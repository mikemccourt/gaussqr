...
%                   POINTS.bdy1 = coordinates of innermost boundary points;
%                   ...
...
%                   NORMALS.n1 = innermost interface normal unit vectors;
%                   ...
...
switch lower(solvertype)
    case 'kansa'
        ...
        for l = 1:N
            ...
            name_bdy = strcat('bdy', lstring);
            name_normals = strcat('n', lstring);
            % Interior points
    ...
    case 'mfs'
        ...
        for l = 1:N
            lstring = num2str(l);
            name_bdy = strcat('bdy', lstring);
            name_normals = strcat('NORMALS', lstring);
