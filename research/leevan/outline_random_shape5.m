...
%             ypred_rnd = rbf(bsxfun(@times, DMeval, epvec)) * (rbf(bsxfun(@times, DM, epvec)) \ y);
    ...
    legend([hsol, hfill], {sprintf('$\\varepsilon=%3.2f$', ep), 'random'}, 'location', 'northwest', 'interpreter', 'latex', 'fontsize', fontsize)
    hold off
