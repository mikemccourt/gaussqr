% SVMCrossValTests
% We study the usefulness of cross-validation as a parameterization
% technique for SVM.  Our pattern here is linearly separable so, despite
% the fact that we use a kernel, we could learn the pattern without one
