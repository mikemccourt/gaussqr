% SVMCrossValTestsNonSep
% This example studies how cross validation can be used in the
% parameterization of a SVM when given a range of ep and bc values
% The example here involves a pattern which is not linearly separable
