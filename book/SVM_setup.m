...
%                    class=2 centered at (0,0), (1,1), (2,0)
...
train_class = ones(train_N+train_N,1);
train_class(train_N+1:train_N+train_N) = -1;
test_data = [grnpop;redpop];
test_class = ones(test_N+test_N,1);
test_class(test_N+1:test_N+test_N) = -1;
